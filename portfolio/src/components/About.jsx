...
export default function About() {
  ...
  return (
    <section id="about" className="relative py-32 px-4 overflow-hidden min-h-[80vh] flex items-center">
      {/* Background Decor */}
      ...
      <div className="max-w-6xl mx-auto relative z-10 w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="mt-4 text-text-muted text-sm font-body text-center">{t('about.clock_label')}</p>
          </motion.div>
        </div>
      </div>
    </section>
