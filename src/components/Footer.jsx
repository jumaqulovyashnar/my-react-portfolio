    ...
    return (
        <footer className="border-t border-white/10 py-5 pb-20 md:pb-5 bg-background/50 text-text-primary">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between text-center md:text-left gap-4 md:gap-6">
                ...
                {/* Social Icon Links (Icons Only) */}
                <div className="flex items-center justify-center gap-3 text-text-secondary">
                    <a
                        href="https://github.com/jumaqulovyashnar"
                        target="_blank"
                        rel="noopener noreferrer"
                        aria-label="GitHub Profile"
                        title="GitHub"
                        className="p-2 rounded-lg bg-white/[0.03] border border-white/10 hover:border-accent-primary/40 hover:text-white hover:bg-white/[0.08] transition-all hover:scale-110"
                    >
                    ...
                    <a
                        href="https://www.instagram.com/jumaqulov_yashnarbek"
                        target="_blank"
                        rel="noopener noreferrer"
                    ...
                    <a
                        href="https://www.linkedin.com/in/yashnar-jumaqulov-708187350"
                        target="_blank"
                        rel="noopener noreferrer"
                ...
                {/* Copyright text */}
                <p className="text-text-muted text-xs sm:text-sm font-body text-center md:text-right shrink-0">
